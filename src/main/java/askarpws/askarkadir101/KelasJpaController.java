 ...
 */
package askarpws.askarkadir101;

import askarpws.askarkadir101.exceptions.IllegalOrphanException;
import askarpws.askarkadir101.exceptions.NonexistentEntityException;
import askarpws.askarkadir101.exceptions.PreexistingEntityException;
...
public class KelasJpaController implements Serializable {
    ...
    private EntityManagerFactory emf = Persistence.createEntityManagerFactory("askarpws_askarkadir101_jar_0.0.1-SNAPSHOTPU");
